...
TopNavBar._patchNetworkLoginSignupLinks = function () {
  ...
  TopNavBar._findInnerElements(TopNavBar.element, '.tnb-login-btn', function (loginLinkElm) {
    loginLinkElm.href = 'https://web.archive.org/web/20240106003845/https://profile.w3schools.com/log-in?redirect_url=' + encodeURIComponent(TopNavBar.location.href);
  });

  TopNavBar._findInnerElements(TopNavBar.element, '.tnb-signup-btn', function (signupLinkElm) {
    signupLinkElm.href = 'https://web.archive.org/web/20240106003845/https://profile.w3schools.com/sign-up?redirect_url=' + encodeURIComponent(TopNavBar.location.href);
  });
}
...
TopNavBar._iframeInit = function () {
  window.addEventListener('message', function (message) {
    ...
    var whitelistedOrigins = [
      'https://web.archive.org/web/20240106003845/https://profile.w3schools.com',
      'https://web.archive.org/web/20240106003845/https://my-learning.w3schools.com',
      'https://web.archive.org/web/20240106003845/https://spaces.w3schools.com',
      'https://web.archive.org/web/20240106003845/https://billing.w3schools.com',
      'https://web.archive.org/web/20240106003845/https://campus.w3schools.com',
    ];
...
TopNavBar.googleSearchInit = function () {
  ...
  if (gSearchScriptElm == null) {
    ...
    gSearchScriptElmToInject.src = 'https://web.archive.org/web/20240106003845/https://www.google.com/cse/cse.js?cx=' + cx;
...
/*
     ...
     INTERNET ARCHIVE ON 02:43:30 Jan 23, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 16.541
  LoadShardBlock: 167.36 (3)
  PetaboxLoader3.datanode: 149.763 (5)
  PetaboxLoader3.resolve: 268.794 (3)
  load_resource: 309.391 (2)
*/