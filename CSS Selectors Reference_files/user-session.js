...
window.UserSession = {
  ...
  _profileBaseUrl: 'https://web.archive.org/web/20240105233422/https://profile.w3schools.com',
};
...
UserSession.getCognitoIssuerUrl = function (cognitoCfg) {
  return 'https://web.archive.org/web/20240105233422/https://cognito-idp.' + cognitoCfg.region + '.amazonaws.com/' + cognitoCfg.userPoolId;
};
...
/*
     FILE ARCHIVED ON 23:34:22 Jan 05, 2024 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 15.798
  LoadShardBlock: 163.213 (3)
  PetaboxLoader3.datanode: 183.557 (5)
  PetaboxLoader3.resolve: 217.213 (3)
  load_resource: 831.976 (2)
*/